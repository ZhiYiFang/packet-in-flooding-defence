 ...
 */
package org.opendaylight.defender.cli.commands;
...
public class DefenderCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DefenderCliTestCommand.class);
    protected final DefenderCliCommands service;

    public DefenderCliTestCommand(final DefenderCliCommands service) {
